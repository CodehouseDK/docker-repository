...
SOURCE_ROOT="https://raw.githubusercontent.com/CodehouseDK/docker-repository/master"

curl "$SOURCE_ROOT/proxy/setup-certs.sh" -o  setup-certs.sh
...
curl "$SOURCE_ROOT/proxy/docker-compose.yml.template" -o  docker-compose.yml.template
...
curl "$SOURCE_ROOT/proxy/nginx.conf.template" -o  nginx.conf.template
